...
LFLAGS := -lpthread -lSDL -lfftw3f -lm -lbz2 -lX11 -llua5.1 -lrt -lpython2.6 -L/usr/lib/python2.6/config -I/usr/include/python2.6 -zmuldef -Xlinker -export-dynamic -Wl,-O1 -Wl,-Bsymbolic-functions
