...
* Version 1.2
      o New element: Metallic Hydrogen.
      o New element: Rechargable Battery.
      o Bug fix
      o Upgraded the element limit.

* Version 1.1
      o Made the Makefile more versatile.
      o Made a CHANGELOG.
      o Made a TODO list.
      o New element: Barium.

* Version 1.0
      o Bug fixes
      o New element: Francium
      o Noble Gasses
      o Fancy Mode
      o Menu Click
      o Favourites Menu
      o New element: Virus
      o New element: Alcohol
      o Decoration Tools
      o New icons
      o Fancy Fire
...
* Version 33.0
      ...
      o Fixed a glitch with diamond that would Made it appear invisible to air pressure.
